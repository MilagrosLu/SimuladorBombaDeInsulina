...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    content: 'Define la glucosa a la que el PID intenta llevar al paciente (estándar: 100 mg/dL). Moviendo el ciruclo hacia la derecha se aumenta el objetivo, hacia la izquierda se disminuye. Si lo cambias, deberás reiniciar la simulación para ver el cambio reflejado.',
  ...
  },
  {
    ...
    content: 'Permite configurar el nivel de glucosa con el que arrancará el paciente. Si difiere del Setpoint, generará un error inicial e(0) inmediato. Si lo cambias, deberás reiniciar la simulación para ver el cambio reflejado.',
  ...
  },
  {
    ...
    content: 'Aca podés modificar los valores de las ganancias del controlador, escribiendo los valores en su box correspondiente. Podés ajustarlos pero para ver su efecto deberás reinicar la simulación.',
